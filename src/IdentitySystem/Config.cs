...
namespace IdentitySystem
{
    public static class Config
    {
        ...
        public static IEnumerable<ApiScope> ApiScopes =>
            new ApiScope[]
            {
                new ApiScope("reportCms"),
                new ApiScope("reportWebKH"),
        ...
        public static IEnumerable<ApiResource> GetApis => 
         new ApiResource[]
            {
                new ApiResource("reportCmsApi")
                {
                    ApiSecrets =
                    {
                        new Secret("reportCMSSecret".Sha256())
                    },
                    Scopes = new List<string> { "reportCms" }
                },
                new ApiResource("reportWebKHApi", "Report Web KH Service")
                {
                    ApiSecrets =
                    {
                        new Secret("reportWebKHSecret".Sha256())
                    },
                    Scopes = new List<string> { "reportWebKH" }
                },
                new ApiResource("workerserviceApi", "Worker Service")
            };
        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                ...
                new Client
                {
                    ...
                    AllowedScopes = { "openid", "profile", "reportCms" },
                ...
                new Client
                {
                    ...
                    AllowOfflineAccess = true,
                    AllowAccessTokensViaBrowser = true,
                    AllowedScopes = { "openid", "profile", "reportWebKH" },
                    RequireClientSecret = false,
                    RequireConsent = false,
